...
public class VeiculoDAO extends AbstractDAO<Veiculo>{
    ...
    public List<Veiculo> buscarTodas() {
        ...
        TypedQuery<Veiculo> query = em.createNamedQuery("Veiculo.buscarTodas", Veiculo.class);
    ...
    public List<Veiculo> buscarPessoaVeiculo(Integer id){
        ...
        TypedQuery<Veiculo> query = em.createNamedQuery("Veiculo.buscarPessoaVeiculo", Veiculo.class);
