...
import ifsp.pep.edu.br.dao.VendaDao;
...
public class main {
    ...
    private static void criarCategoriaEproduto() {
     ...
     private static void criarVenda() {
        ...
        venda1.setPessoa(pessoaDao.obterPeloId(1l));
        venda2.setData(LocalDateTime.now());
        venda2.setPessoa(pessoaDao.obterPeloId(2l));
    ...
    private static void listarTodasVendas() {
        System.out.println("\n" + "Listando todas as Vendas:");
        VendaDao vendaDao = new VendaDao();
        
        System.out.println(vendaDao.obterTodas());        
    }
}
