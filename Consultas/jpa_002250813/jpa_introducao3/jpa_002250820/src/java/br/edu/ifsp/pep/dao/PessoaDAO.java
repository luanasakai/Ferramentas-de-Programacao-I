...
public class PessoaDAO extends AbstractDAO<Pessoa>{
    ...
    public List<Pessoa> findByGerenteSalario(TipoPessoa gerente){
        EntityManager em = getEntityManager();
    
        // Aqui, convertemos o tipo da enum para string antes de usar o LIKE
        TypedQuery<Pessoa> query = em.createNamedQuery("Pessoa.findByGerenteSalario", Pessoa.class);
    ...
    //Obter as pessoas pelo nome. O texto da pesquisa pode estar em qualquer parte do nome
    public List<Pessoa> findByName(String nome){
        EntityManager em = getEntityManager();
    
        // Aqui, convertemos o tipo da enum para string antes de usar o LIKE
        TypedQuery<Pessoa> query = em.createNamedQuery("Pessoa.findByName", Pessoa.class); 
        query.setParameter("nome", "%" + nome + "%");
        
        return query.getResultList();
    }
    
    //Obter o salário médio dos Gerentes.
    public Double obterSalarioMedioGerentes(){
        
        EntityManager em = getEntityManager();
        
        TypedQuery<Double> query = em.createNamedQuery("Pessoa.obterSalarioMedioGerentes", Double.class);
    ...
    //Obter os gerentes que ganham mais do que a média entre eles.
    public List<Pessoa> obterGerentesGanhamMaisQueMedia(){
        EntityManager em = getEntityManager();
   
        TypedQuery<Pessoa> query = em.createNamedQuery("Pessoa.obterGerentesGanhamMaisQueMedia", Pessoa.class);
