...
@Table(name = "produto")
@NamedQueries({
    @NamedQuery(name = "Produto.buscarPelaCategoria", query = "SELECT p FROM Produto p WHERE p.categoria.id = :id")
})
public class Produto implements Serializable {
    ...
    public Produto(String nome, int quantidade, BigDecimal preco, Categoria categoria) {
        this.nome = nome;
